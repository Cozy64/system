    ...
    programs = {
		...
		bash = {
			...
			PS1=$PS1 
				...
				#alias switch="sudo nixos-rebuild switch --flake /home/cozy/flake"
				#alias update="sudo nix-channel --update"
				#alias update="cd /home/cozy/flake&&sudo nix flake update&&cd /home/cozy"
				alias update="cd /etc/nixos && sudo nix flake update && cd ~"
				alias metadata="nix flake metadata /etc/nixos"
				#alias upgrade="sudo nixos-rebuild switch --upgrade-all"
				#alias upgrade="cd /home/cozy/flake&&sudo nix flake update&&sudo nixos-rebuild switch --flake /home/cozy/flake&&cd /home/cozy/"
				alias test="sudo nixos-rebuild test --no-update-lock-file"
				alias garbage="sudo nix-collect-garbage -d"
				alias rollback="sudo nix-channel --rollback"
				alias vinix="sudo -E nvim /etc/nixos/configuration.nix"
				alias cdnix="cd /etc/nixos"
				#alias vinix="nvim /home/cozy/flake/configuration.nix"
				alias viflake="sudo -E nvim /etc/nixos/flake.nix"
				alias viware="sudo -E nvim /etc/nixos/hardware-configuration.nix"
				#alias viware="nvim /home/cozy/flake/hardware-configuration.nix"
