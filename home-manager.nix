    ...
    programs = {
		...
		bash = {
			...
			PS1=$PS1 
				...
				alias boot="sudo nixos-rebuild boot --flakes "/home/cozy/#rust"
				...
				alias switch="sudo nixos-rebuild switch --flakes /home/cozy/#rust"
        ...
        alias cdnix="cd /home/cozy/flakes"
				alias vinix="nvim /home/cozy/flakes/configuration.nix"
				alias vihome="nvim /home/cozy/flakes/home-manager.nix"
