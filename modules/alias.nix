  ...
  home-manager.users.cozy = {
    programs = {
        ...
        alias cdnix="cd /home/cozy/system"
				...
				alias vialias="nvim /home/cozy/system/modules/alias.nix"
				...
				alias vihypr="nvim /home/cozy/system/configs/hypr/hyprland.conf"
				alias VI="sudo -E nvim"
				alias NVIM="sudo -E nvim"
				alias NNN="sudo -E nnn"
        alias mine="sudo /home/cozy/system/xmrig-cpu/xmrig -c /home/cozy/system/xmrig-cpu/config.json"
